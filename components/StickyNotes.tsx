...
const FeatureNotes: React.FC = () => {
  ...
  return (
    ...
    >
      ...
      {/* Projects grid */}
      <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-y-10 -space-x-4 sm:-space-x-6 md:-space-x-8 max-w-7xl px-6">
        {projects.map((project) => (
          <a
            ...
            className={`
              relative w-44 sm:w-48 h-44 p-4 rounded-md
              shadow-[0_6px_10px_rgba(0,0,0,0.15),0_12px_24px_rgba(0,0,0,0.1)]
          ...
          >
            {/* Pin */}
            <div className="absolute top-2 left-1/2 -translate-x-1/2 w-3 h-3 rounded-full bg-gradient-to-b from-red-400 to-red-700 border border-red-800 shadow-[0_2px_4px_rgba(0,0,0,0.4),inset_0_-1px_2px_rgba(255,255,255,0.3)]"></div>

            {/* Project number */}
            <div
              className={`
                absolute top-6 left-8 -translate-x-1/2 text-lg font-bold select-none
                ${
            ...
            {/* Content */}
            <div className="mt-10 text-center relative z-10 px-1">
            ...
            <div
              className={`
    absolute bottom-2 left-1/2 -translate-x-1/2 flex items-center justify-center space-x-1 
